 ...
 * Using a switch statement to map icon names to SVG elements
 */
export function Icon({ name, className = '', size = 'md' }: IconProps): ReactNode {
  const sizes = {
    sm: 'w-4 h-4',
    md: 'w-5 h-5',
    lg: 'w-6 h-6',
  ...
  const baseClass = `${sizes[size]} ${className}`;
